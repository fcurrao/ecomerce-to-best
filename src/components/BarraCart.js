 ...
 const {    listaDeUsarios,totalPrice, cartProducts,setListaDeUsarios, showCart, setShowCart, setHayUsuario, hayUsuario, showLogIn, setshowLogIn, busqueda, setbusqueda, showLogin, setShowLogin, showModal, setShowModal, showSalir,setShowSalir, showRegistrarse, setShowRegistrarse, userOK, setUserOK, formDataUser, setFormdataUser
  ...
  return (<>
    ...
    <div className="cartwidget ">
      ...
      <div style={{border:"1px black solid"}}> <a href="#" onClick={() => abrirCartView()} className="ptext"> {cartProducts.length}  <svg className="svg1 bi bi-cart3" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
        ...
        <div className='todoOpacity'>
          ...
          <div className='contenedordeModal'>
            <div className='modalCart'>
              <button className='botonCerrar' onClick={() => cerrarCartView()}>X</button>
